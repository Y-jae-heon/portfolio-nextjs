...
export const content: PortfolioContent = {
  ...
  headline:
    "주어진 도구로 안 되면 직접 만들고,\n팀에 비어 있는 역할이 있으면\n채워왔습니다.",
  intro:
    "React·React Native 기반 B2B·B2C 서비스를 5년 넘게 리딩하면서, 서드파티 한계에 부딪히면 Android Native 모듈을 직접 개발해 브릿징하고, 타이머 오차가 반복되면 브라우저 렌더링 사이클부터 다시 짚었습니다. 문제의 근본을 찾아 해결하는 방식이 제 기본값입니다.\n\nPM이 없을 때 프로젝트 전반을 리딩하고, 현업과 직접 커뮤니케이션하며 서비스 품질을 지켜온 경험도 있습니다. 저는 프론트엔드 개발자이지만, 제품이 잘 나오는 데 필요한 일이라면 역할의 경계를 크게 두지 않습니다.",
  heroMetrics: [
    {
      value: "80%",
